...
(function () {
    ...
    if (applyForm) {
        applyForm.addEventListener('submit', function (e) {
            ...
            const note = applyForm.querySelector('.form-note');
            ...
            setTimeout(() => {
                ...
                if (note) {
                    note.textContent = 'Thank you. We\'ll review your profile and be in touch within 48 hours.';
                    note.style.color = 'var(--black)';
